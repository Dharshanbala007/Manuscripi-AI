    ...
    <Card>
      ...
      <CardBody className="flex flex-col gap-4">
        <section>
          ...
          <ul className="mt-2 flex flex-col gap-1.5 text-sm text-zinc-700 dark:text-zinc-200">
          ...
          <div className="flex items-center gap-2 text-sm font-medium">
            {contentPreserved ? (
              <>
                ...
                <span className="text-emerald-800 dark:text-emerald-300">Content preservation check passed</span>
              </>
            ) : (
              <>
                <ShieldAlert className="h-4 w-4 text-amber-600 dark:text-amber-400" />
                <span className="text-amber-800 dark:text-amber-300">Review required</span>
              </>
            )}
          </div>
          {contentPreserved ? (
            <ul className="mt-1 text-xs text-emerald-700 dark:text-emerald-300">
